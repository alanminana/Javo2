...
namespace Javo2.ViewModels.Operaciones.Clientes
{
    public class ClientesViewModel
    {
        ...
        // **Solo se valida ProvinciaID y CiudadID, no la propiedad Provincia o Ciudad**
        ...
        // Quitamos la propiedad 'public Provincia Provincia { get; set; }'
        // Quitamos la propiedad 'public Ciudad Ciudad { get; set; }'
        // ... así evitamos que se valide esa propiedad como requerida.
        ...
        // **No** marcamos Ventas como requerida
        // public ICollection<Venta> Ventas { get; set; } // sin [Required]
        ...
        // Historial Compras
        public List<HistorialCompraViewModel> HistorialCompras { get; set; } = new List<HistorialCompraViewModel>();
    }
}
